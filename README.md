...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `29.6µs` | `35.2µs` |
| [Day 2](./src/bin/02.rs) | `42.0µs` | `41.5µs` |
| [Day 3](./src/bin/03.rs) | `116.6µs` | `116.1µs` |
| [Day 4](./src/bin/04.rs) | `53.2µs` | `55.7µs` |
| [Day 5](./src/bin/05.rs) | `23.7µs` | `27.2µs` |
| [Day 6](./src/bin/06.rs) | `203.0ns` | `97.0ns` |
| [Day 7](./src/bin/07.rs) | `129.2µs` | `137.9µs` |

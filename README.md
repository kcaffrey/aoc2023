...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `34.4µs` | `41.8µs` |
| [Day 2](./src/bin/02.rs) | `41.6µs` | `40.6µs` |
| [Day 3](./src/bin/03.rs) | `82.2µs` | `98.5µs` |
| [Day 4](./src/bin/04.rs) | `49.4µs` | `53.0µs` |
| [Day 5](./src/bin/05.rs) | `20.7µs` | `24.1µs` |
| [Day 6](./src/bin/06.rs) | `213.0ns` | `102.0ns` |
| [Day 7](./src/bin/07.rs) | `95.3µs` | `92.0µs` |
| [Day 8](./src/bin/08.rs) | `216.5µs` | `573.9µs` |
